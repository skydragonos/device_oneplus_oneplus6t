...
#define LOG_TAG "android.hardware.health@2.0-service.oneplus6t"
...
using ::device::oneplus::oneplus6t::health::CycleCountBackupRestore;
using ::device::oneplus::oneplus6t::health::LearnedCapacityBackupRestore;
